...
const ProfileModal: React.FC<TProfileModal> = ({
    ...
    return (
        <Modal backdrop="blur" isOpen={isOpen} onClose={onClose} hideCloseButton className="bg-gray-200">
            <ModalContent className="gap-3">
                <ModalHeader className="flex flex-col items-center gap-5">
                    <p className="text-gray-800 font-orbitron">Pass KYC</p>

                    <motion.div whileHover={{ scale: 1.05, opacity: 0.7 }} onClick={handleClick} className="cursor-pointer">
                        <Image src={documentIcon} alt="Avatar" width={150} height={150} className="rounded-full bg-gradient-to-br from-purple-600 to-blue-500 p-2.5" />
                ...
                <ModalFooter>
                    <Button color="danger" variant="light" onPress={discardClose}>Close</Button>
                    <Button color="primary" onPress={passKyc} isDisabled={disableKYCButton}>Save</Button>
                </ModalFooter>
            </ModalContent>
        </Modal>
    );
