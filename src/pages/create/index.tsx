...
import documentIcon from '../../../public/assets/logo.png';
            ...
            {isClient && (
                <div>
                    <div >
                        {isLoading ? (
                            <div
                                className={`mb-4 ${isKycPassed ? 'bg-gray-500 w-96 h-40' : 'bg-gray-500 h-96'
                            ...
                            <Card
                                className={`mb-4 ${isKycPassed ? 'bg-green-500 w-96 h-40' : 'bg-red-500'
                                    }`}
                            >
                                <div className={`p-4 rounded-md font-orbitron`}>
                                    {isKycPassed ? (
                                        ...
                                        <>
                                            ...
                                            <Button
                                                onClick={updateKyc}
                                                className={`${disableKYCButton ? 'bg-red-700' : 'bg-green-500'
                                                    } mt-4`}
                        ...
                        <Button
                            ...
                            className={`${disableCreateButton ? 'bg-red-500' : 'bg-green-500'
                                } mt-4`}
